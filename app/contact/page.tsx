                ...
                <div className="space-y-4 pt-4">
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">hello@failurelab.tech</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-2">
                    <div className="flex h-10 w-10 items-center justify-center rounded-full bg-primary/10">
                ...
                <CardContent className="p-6">
                  <div className="space-y-4">
                    ...
                    <p className="text-sm text-muted-foreground">
                      Have you experienced failure and bounced back? Share your story on our podcast.
                    </p>
                    <Button
                      className="w-full bg-failure-red hover:bg-failure-red/90"
                      onClick={() => (window.location.href = "mailto:guests@failurelab.tech")}
                    >
                      Apply to be a Guest
                    </Button>
                  </div>
